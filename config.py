...
# Get configuration from environment variables (Render Environment Variables)
...
MAX_QUEUE_SIZE = 20
DURATION_LIMIT = 3600  # 1 hour max per song

# List of youtube-dl supported sites for direct downloads
YOUTUBE_DOMAINS = ["youtube.com", "youtu.be", "youtube", "y2u.be", "youtube-nocookie.com", "m.youtube.com"]
